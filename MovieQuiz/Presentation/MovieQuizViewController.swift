...
// шрифты не отображаются в Attributes Inspector
extension UIFont {
...
final class MovieQuizViewController: UIViewController {
    ...
    // Добавил questionTitleLabel, yesButton, noButton что бы прописать шрифты
    ...
    override func viewDidLoad() {
        ...
        // Добавил логику показа первого вопроса
    ...
    private func showNextQuestionOrResults() {
        if currentQuestionIndex == questions.count - 1 {
            let resultMessage = "Ваш результат: \(correctAnswers)/10"
